...
| 字段 | 值 |
|---|---|
| BakeTemplate | BA-P01-PURSUIT-PLAIN（本批投影标签＝census PLAIN_FACTOR_COMBINE，registry v4；因子集→组合——追击型双因子投影） |
...
EVAL_TYPED_FIELD_OR_FACTOR（槽1）：
    用forage_factor事实查询 @PrsForageSchoolProfile
    得到 ForageSchoolFit

EVAL_TYPED_FIELD_OR_FACTOR（槽2）：
    用habitat_factor事实查询 @PrsOpenDeepHabitatProfile
    得到 OpenDeepHabitatFit
