...
| 护巢双路径并行响应 | Response | 26 | 食物∥入侵者两条路径并行评估后合并——不是切换，是并行竞争（∥ 拓扑）。 | <a href="#guard_conflict_dual_path_response">伪脚本</a> · <a href="#guard_conflict_dual_path_response-cfg">配置表</a> |
